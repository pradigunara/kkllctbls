...
var header = __webpack_require__(4309);
// EXTERNAL MODULE: ./components/footer.jsx
var footer = __webpack_require__(1528);
// EXTERNAL MODULE: ./components/breadcrumbs.jsx
var breadcrumbs = __webpack_require__(9702);
    ...
    children: [/*#__PURE__*/jsx_runtime_.jsx(header/* default */.Z, {}), /*#__PURE__*/jsx_runtime_.jsx(breadcrumbs/* default */.Z, {
      ...
      children: /*#__PURE__*/jsx_runtime_.jsx("i", {
        children: /*#__PURE__*/jsx_runtime_.jsx("b", {
          children: "Tap items to cross out, Double tap to add wishlist!"
        })
      })
      ...
      children: sortedSections.map(({
        ...
        const filteredContent = filter_default()(content ?? [], c => showMark ? true : !crossed.has(c.id));
...
function Card({
  ...
  const bindDoubleTap = (0,external_use_double_tap_.useDoubleTap)(e => {
    ...
    onSingleTap: e => {
      ...
      return onSingleTap(e === null || e === void 0 ? void 0 : (_e$target4 = e.target) === null || _e$target4 === void 0 ? void 0 : _e$target4.id);
    }
  });
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)(external_antd_.Col, {
    ...
    children: [/*#__PURE__*/jsx_runtime_.jsx("span", {
      ...
      children: card.name
    }), isWishlist && /*#__PURE__*/jsx_runtime_.jsx("span", {
      style: {
        display: 'flex',
        justifyContent: 'start'
      },
      children: /*#__PURE__*/jsx_runtime_.jsx(icons_.StarFilled, {
        style: {
          fontSize: `${6 / chunk}em`,
          color: 'goldenrod',
          marginBottom: '-1em',
...
async function getStaticProps({
  ...
  var _db$cards, _db$cards$params$memb, _db$sections;
  ...
  const eraSections = ((_db$cards = db.cards) === null || _db$cards === void 0 ? void 0 : (_db$cards$params$memb = _db$cards[params === null || params === void 0 ? void 0 : params.member]) === null || _db$cards$params$memb === void 0 ? void 0 : _db$cards$params$memb[params === null || params === void 0 ? void 0 : params.era]) ?? {};
  const sectionList = ((_db$sections = db.sections) === null || _db$sections === void 0 ? void 0 : _db$sections[params === null || params === void 0 ? void 0 : params.era]) ?? [];
...
var __webpack_exports__ = __webpack_require__.X(0, [922,664,875,209,702], () => (__webpack_exec__(9331)));
